...
type Help4Props = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'Help4'>;
};

const Help4 = ({navigation}:Help4Props) => {
  return (
    <View style={{backgroundColor:'white',height:1000}}>
    <View style={{flexDirection:'column',backgroundColor:'white'}}>
    <View style={{flexDirection:'row',}}>
      <TouchableOpacity onPress={() => navigation.navigate('LearningSection')}>
      <Image
                source={require('../assets/back.png')}
                style={{ width: 25, height: 25, marginLeft: 10, marginTop: 10 }}
              />
              </TouchableOpacity>
      <Text style={{fontSize:20,fontWeight:'bold', marginLeft:120,marginTop:10}} >Contact Us</Text>
    </View>
